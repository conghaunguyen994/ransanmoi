...
// Trò chơi phản xạ nhận thức: chữ "ĐỎ" nhưng được tô màu xanh
// Người chơi phải chọn MÀU của chữ (không phải nghĩa).
// ===========================
function initNeonReflex(containerId) {
    ...
    let flash = null; // {ok:bool, until, x, y}
    ...
    function newRound() {
        ...
        let colorIdx;
        // 70% cơ hội chữ và màu khác nhau (Stroop), 30% trùng - để giữ thử thách
    ...
    function answerClicked(optionIdx, mx, my) {
        ...
        if (optionIdx === r.colorName) {
            // đúng: điểm = thưởng phản xạ nhanh
    ...
    // Bố trí 4 nút đáp án (chọn MÀU của chữ)
    const BTN_TOP = 300;
