...
function initNeonSimon(containerId) {
    ...
    const PADS = [
        { id: 0, color: '#39ff14', a0: Math.PI * 1.0, a1: Math.PI * 1.5 },
        { id: 1, color: '#ff007f', a0: Math.PI * 1.5, a1: Math.PI * 2.0 },
        { id: 2, color: '#00f0ff', a0: Math.PI * 0.0, a1: Math.PI * 0.5 },
        { id: 3, color: '#ffe600', a0: Math.PI * 0.5, a1: Math.PI * 1.0 }
    ];
